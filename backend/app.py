...
def static_files(path):
    try:
        ...
        if os.path.exists(file_path):
            ...
            return f"File {path} not found at {file_path}", 404
    except Exception as e:
...
if __name__ == '__main__':
    ...
    # 개발 서버 실행 - 모든 네트워크에서 접속 가능
    print("\n" + "="*50)
    print("🌍 여행 경로 추적기 서버 시작")
    print("="*50)
    print("📱 모바일 접속:")
    print("   - WiFi로 연결된 상태에서")
    print("   - http://[PC IP 주소]:5000")
    print("   - 예: http://192.168.1.100:5000")
    print()
    print("💻 PC 접속:")
    print("   - http://localhost:5000")
    print("   - http://127.0.0.1:5000")
    print("="*50)
    print("📲 안드로이드에서 PWA 설치 방법:")
    print("1. 위 주소를 크롬 브라우저에서 열기")
    print("2. 주소창 오른쪽 '메뉴(…)' 클릭")
    print("3. '홈 화면에 추가' 또는 '앱 설치' 선택")
    print("="*50)
